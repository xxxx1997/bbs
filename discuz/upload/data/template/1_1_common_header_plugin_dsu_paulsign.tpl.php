...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1419402924, '1', './data/template/1_1_common_header_plugin_dsu_paulsign.tpl.php', './template/default', 'common/header_plugin_dsu_paulsign')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1419402924, '1', './data/template/1_1_common_header_plugin_dsu_paulsign.tpl.php', './template/default', 'common/header_plugin_dsu_paulsign')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1419402924, '1', './data/template/1_1_common_header_plugin_dsu_paulsign.tpl.php', './template/default', 'common/header_plugin_dsu_paulsign')
;?>
