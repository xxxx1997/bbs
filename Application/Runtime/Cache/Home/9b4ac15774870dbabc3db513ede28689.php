...
div{position:absolute;width:66px;height:45px;background:url(/Application/Common/img/1.gif) no-repeat;top:100px;left:50px;}
p,input{margin:10px;}
</style>
...
window.onload = function ()
{
	...
	{		
		...
		document.onclick = function (event)
		{
			...
			oDiv.style.background = "url(/Application/Common/img/2.gif) no-repeat";
			startMove(oDiv, {x:event.clientX, y:event.clientY}, function(){oDiv.style.background = "url(/Application/Common/img/1.gif) no-repeat"});
			return false;
		}	
	};
	...
	{		
		...
		document.onmouseup = function ()
		{
			...
			var timer = setInterval(function ()
			{
				...
				{
					clearInterval(timer);
					oDiv.style.background = "url(/Application/Common/img/1.gif) no-repeat";
					return;	
				};
