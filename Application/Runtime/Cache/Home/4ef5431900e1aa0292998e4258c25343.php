...
<body>
    ...
    <li><a href="#tab1" class="selected">发布通知</a></li> 
        ...
        <form action="/Home/Admin/upd" method="post" enctype="multipart/form-data">
    ...
    <li><label>课程标题<b>*</b></label><input name="class_title" type="text" class="dfinput" value="<?php echo $info['class_title']?>"  style="width:518px;"/></li>
    ...
    <div class="vocation">
        <select  name='class_type' class="select1" >
                <option value="1" <?php if($info['class_type']==1){echo 'selected';}?>>php基础班</option>
                <option value="2" <?php if($info['class_type']==2){echo 'selected';}?> >php就业班</option>
                <option value="3" <?php if($info['class_type']==3){echo 'selected';}?> >php远程班</option>
        </select>
    </div>
    
    </li>
   
    <li><label>是否开班<b>*</b></label>开班:<input name="class_state" type="radio"  value="2"  style="width:50px;" <?php if($info['class_state']==1){echo 'checked';}?>/>不开班:<input name="class_state" type="radio"  value="1"  style="width:50px;" <?php if($info['class_state']==2){echo 'checked';}?>/>
    </li>
