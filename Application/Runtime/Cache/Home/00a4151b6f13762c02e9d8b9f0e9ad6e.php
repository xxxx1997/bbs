...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
            <li ><a href="/Home/Question/addd"><span><img src="/Application/Common/admin/images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        <tbody>
            <?php if(is_array($info)): foreach($info as $key=>$it): ?><tr id="tr<?php echo ($it["p_id"]); ?>">   
        <td><?php echo ($it["p_id"]); ?></td>
        <td><?php echo ($it["p_title"]); ?></td>
        <td><?php echo date('Y-m-d',$it['start_time']) ?></td>
        <td><?php echo mb_substr($it['p_content'], 0, 15, 'utf-8')."...."; ?></td>
        <td><?php if($it['t_id']==1){ echo "常见问题"; }else{ echo "php问题"; }?></td>
<td><a href="/Home/Question/sel?id=<?php echo ($it["p_id"]); ?>" class="tablelink">查看</a>     <a href="#" class="tablelink" onclick="del('<?php echo ($it["p_id"]); ?>')"> 删除</a></td>
