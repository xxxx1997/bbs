...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
            <li class="click"><a href="<?php echo U('article/add_class');?>"><span><img src="/addbbs/Application/Common/admin/images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        <td><a href="<?php echo U('article/see_class',array('id'=>$vo['id']));?>" class="tablelink">查看</a>     <a href="#" onclick="del('<?php echo ($vo["id"]); ?>')" class="tablelink"> 删除</a></td>
