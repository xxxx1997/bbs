...
<title>无标题文档</title>
<link href="/bbs/Application/Common/admin/css/style.css" rel="stylesheet" type="text/css" />
<link href="/bbs/Application/Common/admin/css/select.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/bbs/Application/Common/admin/js/jquery.js"></script>
<script type="text/javascript" src="/bbs/Application/Common/admin/js/jquery.idTabs.min.js"></script>
<script type="text/javascript" src="/bbs/Application/Common/admin/js/select-ui.min.js"></script>
<script type="text/javascript" src="/bbs/Application/Common/admin/editor/kindeditor.js"></script>
...
<body>
    ...
    <li><a href="#tab1" class="selected">发布通知</a></li> 
        ...
        <form action="<?php echo U('article/add_class_do');?>" method="post" enctype="multipart/form-data">
