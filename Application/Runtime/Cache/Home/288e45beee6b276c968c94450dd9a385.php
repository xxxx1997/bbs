...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
            <li class="click"><a href="/Home/article/add_class.html"><span><img src="/Application/Common/admin/images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        <td><a href="/Home/article/see_class/id/1.html" class="tablelink">查看</a>     <a href="#" onclick="del('1')" class="tablelink"> 删除</a></td>
        </tr> 
        </tbody>
    </table>
        <script>
            function del(id){
                ...
                if(confirm('确认删除么?')){
                    $.ajax({
                        type: "POST",
                        url: "/Home/article/del_class.html",
                        data: "id="+id,
