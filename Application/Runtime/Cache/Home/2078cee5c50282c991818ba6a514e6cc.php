...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
            <li class="click"><a href="<?php echo U('article/add');?>"><span><img src="/bbs/Application/Common/admin/images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        <td><img width='100'height='50' src="/bbs/Application/Common/Public/<?php echo ($vo["a_thumb"]); ?>"</td>        
        <td><a href="<?php echo U('article/see',array('aid'=>$vo['aid']));?>" class="tablelink">查看</a>     <a href="#" onclick="del('<?php echo ($vo["aid"]); ?>')" class="tablelink"> 删除</a></td>
