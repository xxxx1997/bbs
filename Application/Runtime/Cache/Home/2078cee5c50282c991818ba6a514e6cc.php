...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
            <li class="click"><a href="<?php echo U('article/add');?>"><span><img src="/Application/Common/admin/images/t01.png" /></span>添加</a></li>
    ...
    <table class="tablelist">
        ...
        <td><img width='100'height='50' src="/Application/Common/Public/<?php echo ($vo["a_thumb"]); ?>"</td>        
