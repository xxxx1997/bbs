...
<body>
    ...
    <div class="formbody">
        ...
        <div class="formtitle"><a href="/Home/Teacher/teacher_list"><span>列表</span></a></div>
        <form action="/Home/Teacher/update?t_id=<?php echo ($_GET['t_id']); ?>" method="post" enctype="multipart/form-data">
    <ul class="forminfo">
