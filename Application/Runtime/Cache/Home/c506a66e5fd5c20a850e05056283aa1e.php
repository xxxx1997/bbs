...
<body>
    ...
    <div class="welinfo">
    <span><img src="/bbs/Application/Common/admin/images/sun.png" alt="天气" /></span>
    <b>Admin早上好，欢迎使用信息管理系统</b>(admin@uimaker.com)
    <a href="#">帐号设置</a>
    </div>
    
    <div class="welinfo">
    <span><img src="/bbs/Application/Common/admin/images/time.png" alt="时间" /></span>
    ...
    <li><img src="/bbs/Application/Common/admin/images/ico01.png" /><p><a href="#">管理设置</a></p></li>
    <li><img src="/bbs/Application/Common/admin/images/ico02.png" /><p><a href="#">发布文章</a></p></li>
    <li><img src="/bbs/Application/Common/admin/images/ico03.png" /><p><a href="#">数据统计</a></p></li>
    <li><img src="/bbs/Application/Common/admin/images/ico04.png" /><p><a href="#">文件上传</a></p></li>
    <li><img src="/bbs/Application/Common/admin/images/ico05.png" /><p><a href="#">目录管理</a></p></li>
    <li><img src="/bbs/Application/Common/admin/images/ico06.png" /><p><a href="#">查询</a></p></li> 
            
    </ul>
    
    <div class="ibox"><a class="ibtn"><img src="/bbs/Application/Common/admin/images/iadd.png" />添加新的快捷功能</a></div>
    
    <div class="xline"></div>
    <div class="box"></div>
    
    <div class="welinfo">
    <span><img src="/bbs/Application/Common/admin/images/dp.png" alt="提醒" /></span>
