...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class="click"><a href="<?php echo U('video/add');?>"><span><img src="/bbs/Application/Common/admin/images/t01.png" /></span>添加</a></li>
    ...
    <span><img width='170' height='135' src="/bbs/Application/Common/Public/<?php echo ($vo["v_thumb"]); ?>" /></span>
