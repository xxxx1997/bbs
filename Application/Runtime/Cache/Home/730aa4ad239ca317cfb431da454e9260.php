...
<title>无标题文档</title>
<link href="/two/Application/Common/admin/css/style.css" rel="stylesheet" type="text/css" />
<link href="/two/Application/Common/admin/css/select.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/two/Application/Common/admin/js/jquery.js"></script>
<script type="text/javascript" src="/two/Application/Common/admin/js/jquery.idTabs.min.js"></script>
<script type="text/javascript" src="/two/Application/Common/admin/js/select-ui.min.js"></script>
<script type="text/javascript" src="/two/Application/Common/admin/editor/kindeditor.js"></script>
...
<body>
    ...
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">修改</a></li> 
    
  	</ul>
    </div> 
        <form action="<?php echo U('nav/nav_upd_do');?>" method="post" enctype="multipart/form-data">
  	<div id="tab1" class="tabson">
    
    <div class="formtext">Hi，<b>admin</b>，欢迎您试用信息发布功能！</div>
    
    <ul class="forminfo">
    <input name="n_id" type="hidden" class="dfinput" value="<?php echo ($list['n_id']); ?>"  style="width:518px;"/>
    <li><label>名称<b>*</b></label><input name="n_name" type="text" class="dfinput" value="<?php echo ($list['n_name']); ?>"  style="width:518px;"/></li>
    <li><label>url<b>*</b></label><input name="n_url" type="text" class="dfinput" value="<?php echo ($list['n_url']); ?>"  style="width:518px;"/>       <font color="red">a/b a控制器 b方法名</font></li>
