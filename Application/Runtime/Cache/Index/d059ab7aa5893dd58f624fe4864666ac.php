...
<!--输出-->
 <div id="box">
  <div class="position"><a name="pagetop"/>您现在的位置：<span class="STYLE5"><a href="http://www.itcast.cn">首页</a> &gt;&gt; 企业招聘 &gt;&gt; 正文</span></div>
  <div id="left" class="fl" style="margin-top:8px;">
    <div class="left_content1">
      <div id="printarea">
          <?php if(is_array($info)): foreach($info as $key=>$in): ?><h1 class="infotitle"><?php echo ($in["a_title"]); ?></h1>
        <div class="editer">更新时间: 来源:传智播客</div>
        <div class="infor">
         　　
<?php echo ($in["a_content"]); ?>
<script type="text/javascript" src="http://bbs.itcast.cn/api.php?mod=js&bid=94"></script>
        </div>
      </div><?php endforeach; endif; ?>
      <div class="pre">
	               上一篇：<a target="_blank" href="/news/20141208/14061592998.shtml"><?php echo ($info); ?></a>
       	  </div>
      <div class="next">
